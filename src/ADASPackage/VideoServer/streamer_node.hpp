...
typedef struct {
	...
	const gchar* IP_adress = "127.0.0.1";
	guint  Port= 5000;
...
static void cb_need_Data(GstElement *appsrc, guint unused_size, gpointer user_data)
{
	...
	if (resize)
	{
		...
		cout<<"======================================================"<<endl;
		cout<<"    Streamer resizing to "<< app.in_width<<"x"<<app.in_height<<"   Format: "<< app.format<<endl;
		cout<<"======================================================"<<endl<<endl<<endl;
...
gboolean streamer_run(guint in_framerate, guint out_width, guint out_height) {
	...
	gst_object_unref(app.bus);
	 ...
	 g_object_set(G_OBJECT(app.sink), "host", app.IP_adress, NULL);
...
class Streamer : public rclcpp::Node
{
	...
	public:  Streamer( const std::string & input, const std::string IP, int port, const std::string & node_name = "streamer_node")
					 : Node(node_name, true)
	{
			   ...
			   {
				   {
				     ...
				     cout<<endl<<endl<<endl;
			   		 ...
			   		 cout<<"======================================================"<<endl;
			   		 cout<< " Feeding frames to--->"<<app.IP_adress<<":"<<app.Port<<endl<<endl<<endl;
				   }
			   }
