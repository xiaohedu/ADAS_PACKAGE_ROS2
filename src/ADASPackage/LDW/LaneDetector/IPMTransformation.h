...
void IPMgetInterpMap(const cv::Mat& xMap,
                     const cv::Mat& yMap,
...
void IPMgetColBounds(const double& y, const cv::Mat& yMap, const int& r12, const int& r34, std::vector<double>& cVec);
...
void IPMgetIndices(const int& m,
                   const int& mCropped,
                   const int& n,
...
void IPMgetWeights(const double& x,
                   const double& y,
                   const std::vector<double>& rVec,
                   const std::vector<double>& cVec,
                   const cv::Mat& xMap,
